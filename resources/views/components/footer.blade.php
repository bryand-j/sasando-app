 <footer class="bg-white py-32 dark:bg-transparent">
     <div class="mx-auto max-w-5xl px-6">
         <a href="/" aria-label="go home" class="mx-auto block size-fit">
             <img width="36" height="36" src="logo.png" alt="logo" />
         </a>
         ...
         <div class="my-8 flex flex-wrap justify-center gap-6 text-sm">
             <a href="#" target="_blank" aria-label="X/Twitter" class="text-body block hover:text-title">
                 <svg class="size-6" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                     viewBox="0 0 24 24">
         ...
         <span class="text-caption block text-center text-sm">&copy 2025 Sasando, All rights reserved</span>
     </div>
 </footer>
